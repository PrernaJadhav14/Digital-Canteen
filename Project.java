...
class Project extends JFrame implements ActionListener {
   ...
   //
        ...
        in = new JLabel("THE INITIATIVE");
        // title.setHorizontalAlignment(SwingConstants.CENTER);
        in.setForeground(Color.BLACK);
        in.setFont(new Font("Arial", Font.BOLD, 30));
        in.setSize(350, 70);
        in.setLocation(550, 40);
        c.add(in);

        tout = new JTextArea();
        tout.setFont(new Font("Arial", Font.BOLD, 25));
        tout.setText("This project is an "+"\n"+
                "initiative to solve the"+"\n"+"mess created around the"+"\n"+"canteen area by making"+
        " maximum order process digital");
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (e.getSource() == sub) {
            if (term.isSelected() ) {
                ...
                new com.company.Choice().setVisible(true);
                this.dispose();
            }
            else {
                tout.setText("");
